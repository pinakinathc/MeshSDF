...
import tqdm
import wandb
wandb.init(project="SDFAutoEncoder", name="SDF_NCE")
...
def main_function(experiment_directory, continue_from):
    ...
    decoder.load_state_dict(torch.load('./experiments/decoder_init.py')['model_state_dict'])
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for sdf_data, pointset, name, indices in tqdm.tqdm(sdf_loader):
            ...
            batch_loss = batch_loss + nce_reg_loss
            batch_loss.backward()
